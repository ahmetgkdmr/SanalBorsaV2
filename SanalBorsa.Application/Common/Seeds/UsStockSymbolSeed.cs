...
/// <summary>
/// S&amp;P 500'ün tamamı (503 sembol — Alphabet'in iki pay sınıfı GOOG/GOOGL dahil olduğu için
/// 500'den fazla). Wikipedia'nın canlı "List of S&amp;P 500 companies" sayfasından (constituents
/// tablosu, template data-mw parametreleri) çekildi. ABD sembollerinde Yahoo Finance eki yok
/// (BIST'in ".IS"'i gibi); Yahoo sembolü = ham sembol. Nokta içeren sembol sınıfları (BRK.B,
/// BF.B) Yahoo/TradingView konvansiyonuna göre tireye çevrildi (BRK-B, BF-B).
/// </summary>
public static class UsStockSymbolSeed
{
